...
-- command_name: Tauri 命令名（用于前端适配器动态加载 HTTP 路由映射）
-- http_method: HTTP 方法（GET/POST/PUT/DELETE）
-- http_path: HTTP 路径模板（如 '/api/categories/{id}'）
-- ==============================
...
VALUES (
        1,
        'admin',
        '$argon2id$v=19$m=19456,t=2,p=1$iBgqWh/LgwmCcfXByfgy/Q$s/j6aLm9NzqlouAPvYehwEMjIN7CfOjBS7kcQKjoee0',
        NULL,
        '系统管理员',
        'admin@example.com',
        '13800138000',
