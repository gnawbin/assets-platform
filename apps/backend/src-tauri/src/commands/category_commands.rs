...
pub async fn get_categories() -> Result<Vec<AssetCategory>, String> {
    assets_service::assets_categories_service::get_categories().await
}

/// 获取所有资产类别列表
#[tauri::command]
pub async fn get_categories_parents() -> Result<Vec<AssetCategory>, String> {
    assets_service::assets_categories_service::get_super_categories().await
}

/// 新增资产类别
#[tauri::command]
pub async fn insert_category(category: AssetCategory) -> Result<AssetCategory, String> {
    assets_service::assets_categories_service::insert_category(&category).await
}

/// 更新资产类别
#[tauri::command]
pub async fn update_category(category: AssetCategory) -> Result<AssetCategory, String> {
    assets_service::assets_categories_service::update_category(&category).await
}
...
pub async fn delete_category(id: String) -> Result<(), String> {
    ...
    assets_service::assets_categories_service::delete_category(id).await
}
