...
pub async fn register(
    ...
    match assets_service::register_service::register(
        &req.username,
        &req.password,
        &req.real_name,
        req.email.as_deref(),
...
pub async fn get_registrations(
    ...
    match assets_service::register_service::get_registrations(query.status).await {
...
pub async fn approve_registration(
    ...
    match assets_service::register_service::approve_registration(
        id,
        claims.sub,
        req.tenant_id,
...
pub async fn reject_registration(
    ...
    match assets_service::register_service::reject_registration(
        id,
        claims.sub,
        req.approve_remark.as_deref(),
    )
