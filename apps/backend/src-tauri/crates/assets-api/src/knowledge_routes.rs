...
use assets_database::models::{AssetKnowledge, KnowledgeTree, KnowledgeTreeNode};
use assets_service;
...
pub async fn get_tree() -> Result<Json<ApiResponse<Vec<KnowledgeTreeNode>>>, ApiError> {
    ...
    match assets_service::knowledge_service::get_knowledge_tree().await {
...
pub async fn insert_node(
    ...
    match assets_service::knowledge_service::insert_knowledge_node(
        kid,
        pid,
        &req.node_type,
        &req.title,
...
pub async fn update_node(
    ...
    match assets_service::knowledge_service::update_knowledge_node(
        node_id,
        req.title.as_deref(),
        req.icon.as_deref(),
        req.sort_order,
...
pub async fn delete_node(Path(id): Path<String>) -> Result<Json<ApiResponse<()>>, ApiError> {
    ...
    match assets_service::knowledge_service::delete_knowledge_node(node_id).await {
...
pub async fn move_node(
    ...
    match assets_service::knowledge_service::move_knowledge_node(node_id, npid).await {
        Ok(node) => Ok(Json(ApiResponse::success(node))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn get_list(
    ...
    match assets_service::knowledge_service::get_knowledge_list(kid, query.keyword).await {
...
pub async fn get_by_id(
    ...
    match assets_service::knowledge_service::get_knowledge_by_id(kid).await {
...
pub async fn insert_knowledge(
    ...
    match assets_service::knowledge_service::insert_knowledge(
        aid,
...
pub async fn update_knowledge(
    ...
    match assets_service::knowledge_service::update_knowledge(
        kid,
        req.title.as_deref(),
...
pub async fn delete_knowledge(Path(id): Path<String>) -> Result<Json<ApiResponse<()>>, ApiError> {
    ...
    match assets_service::knowledge_service::delete_knowledge(kid).await {
        Ok(_) => Ok(Json(ApiResponse::success(()))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
