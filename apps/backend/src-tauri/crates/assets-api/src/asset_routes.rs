...
pub async fn get_hardware_assets() -> Result<Json<ApiResponse<Vec<HardwareAssetView>>>, ApiError> {
    match assets_service::assets_service::get_hardware_assets().await {
...
pub async fn insert_hardware_asset(
    ...
    match assets_service::assets_service::insert_hardware_asset(input, ctx.user_id).await {
...
pub async fn update_hardware_asset(
    ...
    match assets_service::assets_service::update_hardware_asset(id, input, ctx.user_id).await {
        Ok(asset) => Ok(Json(ApiResponse::success(asset))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn delete_hardware_asset(
    ...
    match assets_service::assets_service::delete_hardware_asset(id).await {
...
{
    match assets_service::assets_service::get_intangible_assets().await {
        Ok(assets) => Ok(Json(ApiResponse::success(assets))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn insert_intangible_asset(
    ...
    match assets_service::assets_service::insert_intangible_asset(input, ctx.user_id).await {
        Ok(asset) => Ok(Json(ApiResponse::success(asset))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn update_intangible_asset(
    ...
    match assets_service::assets_service::update_intangible_asset(id, input, ctx.user_id).await {
        Ok(asset) => Ok(Json(ApiResponse::success(asset))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn delete_intangible_asset(
    ...
    match assets_service::assets_service::delete_intangible_asset(id).await {
        Ok(_) => Ok(Json(ApiResponse::success(()))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
