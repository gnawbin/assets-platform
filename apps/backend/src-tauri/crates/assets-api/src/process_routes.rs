...
pub async fn get_receives() -> Result<Json<ApiResponse<Vec<AssetReceive>>>, ApiError> {
    match assets_service::process_service::get_receives().await {
...
pub async fn insert_receive(
    ...
    match assets_service::process_service::insert_receive(input).await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn update_receive(
    ...
    match assets_service::process_service::update_receive(id, input).await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn delete_receive(Path(id): Path<String>) -> Result<Json<ApiResponse<()>>, ApiError> {
    let id: i64 = id.parse().map_err(|_| ApiError::bad_request("无效的ID"))?;
    match assets_service::process_service::delete_receive(id).await {
...
pub async fn get_returns() -> Result<Json<ApiResponse<Vec<AssetReturn>>>, ApiError> {
    match assets_service::process_service::get_returns().await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn insert_return(
    ...
    match assets_service::process_service::insert_return(input).await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn update_return(
    ...
    let id: i64 = id.parse().map_err(|_| ApiError::bad_request("无效的ID"))?;
    match assets_service::process_service::update_return(id, input).await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn delete_return(Path(id): Path<String>) -> Result<Json<ApiResponse<()>>, ApiError> {
    let id: i64 = id.parse().map_err(|_| ApiError::bad_request("无效的ID"))?;
    match assets_service::process_service::delete_return(id).await {
        Ok(_) => Ok(Json(ApiResponse::success(()))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn get_transfers() -> Result<Json<ApiResponse<Vec<AssetTransfer>>>, ApiError> {
    match assets_service::process_service::get_transfers().await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn insert_transfer(
    ...
    match assets_service::process_service::insert_transfer(input).await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn update_transfer(
    ...
    let id: i64 = id.parse().map_err(|_| ApiError::bad_request("无效的ID"))?;
    match assets_service::process_service::update_transfer(id, input).await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn delete_transfer(Path(id): Path<String>) -> Result<Json<ApiResponse<()>>, ApiError> {
    let id: i64 = id.parse().map_err(|_| ApiError::bad_request("无效的ID"))?;
    match assets_service::process_service::delete_transfer(id).await {
        Ok(_) => Ok(Json(ApiResponse::success(()))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn get_repairs() -> Result<Json<ApiResponse<Vec<AssetRepair>>>, ApiError> {
    match assets_service::process_service::get_repairs().await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn insert_repair(
    ...
    match assets_service::process_service::insert_repair(input).await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn update_repair(
    ...
    let id: i64 = id.parse().map_err(|_| ApiError::bad_request("无效的ID"))?;
    match assets_service::process_service::update_repair(id, input).await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn delete_repair(Path(id): Path<String>) -> Result<Json<ApiResponse<()>>, ApiError> {
    let id: i64 = id.parse().map_err(|_| ApiError::bad_request("无效的ID"))?;
    match assets_service::process_service::delete_repair(id).await {
        Ok(_) => Ok(Json(ApiResponse::success(()))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn get_scraps() -> Result<Json<ApiResponse<Vec<AssetScrap>>>, ApiError> {
    match assets_service::process_service::get_scraps().await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn insert_scrap(
    ...
    match assets_service::process_service::insert_scrap(input).await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn update_scrap(
    ...
    let id: i64 = id.parse().map_err(|_| ApiError::bad_request("无效的ID"))?;
    match assets_service::process_service::update_scrap(id, input).await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn delete_scrap(Path(id): Path<String>) -> Result<Json<ApiResponse<()>>, ApiError> {
    let id: i64 = id.parse().map_err(|_| ApiError::bad_request("无效的ID"))?;
    match assets_service::process_service::delete_scrap(id).await {
        Ok(_) => Ok(Json(ApiResponse::success(()))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn get_purchases() -> Result<Json<ApiResponse<Vec<AssetPurchase>>>, ApiError> {
    match assets_service::process_service::get_purchases().await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn insert_purchase(
    ...
    match assets_service::process_service::insert_purchase(input).await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn update_purchase(
    ...
    let id: i64 = id.parse().map_err(|_| ApiError::bad_request("无效的ID"))?;
    match assets_service::process_service::update_purchase(id, input).await {
        Ok(data) => Ok(Json(ApiResponse::success(data))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
...
pub async fn delete_purchase(Path(id): Path<String>) -> Result<Json<ApiResponse<()>>, ApiError> {
    let id: i64 = id.parse().map_err(|_| ApiError::bad_request("无效的ID"))?;
    match assets_service::process_service::delete_purchase(id).await {
        Ok(_) => Ok(Json(ApiResponse::success(()))),
        Err(e) => Err(ApiError::internal_error(e)),
    }
}
